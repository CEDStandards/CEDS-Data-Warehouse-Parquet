/****** Object:  View [RDS].[vwFactK12StudentEconomicDisadvantagesParquet]    Script Date: 5/10/2022 2:48:07 PM ******/
...
SELECT fact.FactK12StudentEconomicDisadvantageId
	...
	, PersonAddress.CountryCode AS PersonAddress_CountryCode
	, PersonAddress.CountryDescription AS PersonAddress_CountryDescription
	, PersonAddress.Latitude AS PersonAddress_Latitude
	, PersonAddress.Longitude AS PersonAddress_Longitude
	, PersonAddress.CountyAnsiCode AS PersonAddress_CountyAnsiCode
	, PersonAddress.CountyAnsiDescription AS PersonAddress_CountyAnsiDescription
