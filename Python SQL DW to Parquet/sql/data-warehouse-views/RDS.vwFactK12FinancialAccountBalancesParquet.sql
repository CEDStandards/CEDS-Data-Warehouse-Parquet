-- View: RDS.vwFactK12FinancialAccountBalancesParquet
-- Generated from database export

CREATE VIEW [RDS].[vwFactK12FinancialAccountBalancesParquet] AS
CREATE   VIEW RDS.vwFactK12FinancialAccountBalancesParquet AS SELECT fact.FactK12FinancialAccountBalanceId
