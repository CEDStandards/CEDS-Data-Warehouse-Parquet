CREATE OR ALTER VIEW [RDS].[vwFactK12StaffEvaluationPartsParquet] AS
	SELECT fact.FactK12StaffEvaluationPartId
	...
	, fact.StaffEvaluationOutcome
	, fact.StaffEvaluationPartScale
	, fact.StaffEvaluationPartScoreOrRating
	, fact.StaffEvaluationScale
	, fact.StaffEvaluationScoreOrRating
	, StaffEvaluationPartStatus.StaffEvaluationSystem AS StaffEvaluationPartStatus_StaffEvaluationSystem
	, StaffEvaluationPartStatus.FacultyAndAdministrationPerformanceLevelCode AS StaffEvaluationPartStatus_FacultyAndAdministrationPerformanceLevelCode
	, StaffEvaluationPartStatus.FacultyAndAdministrationPerformanceLevelDescription AS StaffEvaluationPartStatus_FacultyAndAdministrationPerformanceLevelDescription
	, StaffEvaluationPartStatus.TechnologySkillsStandardsMetCode AS StaffEvaluationPartStatus_TechnologySkillsStandardsMetCode
	, StaffEvaluationPartStatus.TechnologySkillsStandardsMetDescription AS StaffEvaluationPartStatus_TechnologySkillsStandardsMetDescription
	, StaffEvaluationPartStatus.StaffEvaluationPartName AS StaffEvaluationPartStatus_StaffEvaluationPartName
	, StaffEvaluationScale.StaffEvaluationScaleCode AS StaffEvaluationScale_StaffEvaluationScaleCode
	, StaffEvaluationScale.StaffEvaluationScaleDescription AS StaffEvaluationScale_StaffEvaluationScaleDescription
...
FROM RDS.FactK12StaffEvaluationParts fact
...
JOIN RDS.DimStaffEvaluationPartStatuses StaffEvaluationPartStatus
	ON fact.StaffEvaluationPartStatusId = StaffEvaluationPartStatus.DimStaffEvaluationPartStatusId
JOIN RDS.DimStaffEvaluationScales StaffEvaluationScale
	ON fact.StaffEvaluationScaleId = StaffEvaluationScale.DimStaffEvaluationScaleId
