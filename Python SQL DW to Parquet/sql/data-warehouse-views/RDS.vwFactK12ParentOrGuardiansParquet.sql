-- View: RDS.vwFactK12ParentOrGuardiansParquet
-- Generated from database export

CREATE VIEW [RDS].[vwFactK12ParentOrGuardiansParquet] AS
CREATE   VIEW RDS.vwFactK12ParentOrGuardiansParquet AS SELECT fact.FactK12ParentOrGuardianId
