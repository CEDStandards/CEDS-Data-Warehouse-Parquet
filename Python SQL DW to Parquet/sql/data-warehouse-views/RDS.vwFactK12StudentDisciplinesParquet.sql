-- View: RDS.vwFactK12StudentDisciplinesParquet
-- Generated from database export

CREATE VIEW [RDS].[vwFactK12StudentDisciplinesParquet] AS
CREATE   VIEW RDS.vwFactK12StudentDisciplinesParquet AS SELECT fact.FactK12StudentDisciplineId
