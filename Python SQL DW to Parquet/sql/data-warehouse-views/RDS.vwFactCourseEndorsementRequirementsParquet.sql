CREATE OR ALTER VIEW [RDS].[vwFactCourseEndorsementRequirementsParquet] AS
	SELECT fact.FactK12CourseEndorsementRequirementId
...
FROM RDS.FactCourseEndorsementRequirements fact
