CREATE OR ALTER VIEW [RDS].[vwFactK12StaffCompensationsParquet] AS
	SELECT fact.FactK12StaffCompensationId
	...
	, StaffCompensationType.StaffCompensationTypeCode AS StaffCompensationType_StaffCompensationTypeCode
	, StaffCompensationType.StaffCompensationTypeDescription AS StaffCompensationType_StaffCompensationTypeDescription
	, fact.StaffCompensation
	, fact.StaffCompensationDescription
	, fact.FundingSourceAmount
	, fact.FundingSourcePercentage
	, FundingSourceFinancialAccount.FinancialAccountNumber AS FundingSourceFinancialAccount_FinancialAccountNumber
	, FundingSourceFinancialAccount.FinancialAccountName AS FundingSourceFinancialAccount_FinancialAccountName
	, FundingSourceFinancialAccount.FinancialAccountDescription AS FundingSourceFinancialAccount_FinancialAccountDescription
	, FundingSourceFinancialAccount.RecordStartDateTime AS FundingSourceFinancialAccount_RecordStartDateTime
	, FundingSourceFinancialAccount.RecordEndDateTime AS FundingSourceFinancialAccount_RecordEndDateTime
...
FROM RDS.FactK12StaffCompensations fact
...
JOIN RDS.DimStaffCompensationTypes StaffCompensationType
	ON fact.StaffCompensationTypeId = StaffCompensationType.DimStaffCompensationTypeId
JOIN RDS.DimFinancialAccounts FundingSourceFinancialAccount
	ON fact.FundingSourceFinancialAccountId = FundingSourceFinancialAccount.DimFinancialAccountId
