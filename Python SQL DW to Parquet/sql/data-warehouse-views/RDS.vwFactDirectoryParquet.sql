CREATE OR ALTER VIEW [RDS].[vwFactDirectoryParquet] AS
	...
	, ComprehensiveAndTargetedSuppor.AdditionalTargetedSupportAndImprovementStatusCode AS ComprehensiveAndTargetedSuppor_AdditionalTargetedSupportAndImprovementStatusCode
	, ComprehensiveAndTargetedSuppor.AdditionalTargetedSupportAndImprovementStatusDescription AS ComprehensiveAndTargetedSuppor_AdditionalTargetedSupportAndImprovementStatusDescription
	, ComprehensiveAndTargetedSuppor.AdditionalTargetedSupportAndImprovementStatusEdFactsCode AS ComprehensiveAndTargetedSuppor_AdditionalTargetedSupportAndImprovementStatusEdFactsCode
	, ComprehensiveAndTargetedSuppor.ComprehensiveSupportAndImprovementStatusCode AS ComprehensiveAndTargetedSuppor_ComprehensiveSupportAndImprovementStatusCode
	, ComprehensiveAndTargetedSuppor.ComprehensiveSupportAndImprovementStatusDescription AS ComprehensiveAndTargetedSuppor_ComprehensiveSupportAndImprovementStatusDescription
	, ComprehensiveAndTargetedSuppor.ComprehensiveSupportAndImprovementStatusEdFactsCode AS ComprehensiveAndTargetedSuppor_ComprehensiveSupportAndImprovementStatusEdFactsCode
	, ComprehensiveAndTargetedSuppor.TargetedSupportAndImprovementStatusCode AS ComprehensiveAndTargetedSuppor_TargetedSupportAndImprovementStatusCode
	, ComprehensiveAndTargetedSuppor.TargetedSupportAndImprovementStatusDescription AS ComprehensiveAndTargetedSuppor_TargetedSupportAndImprovementStatusDescription
	, ComprehensiveAndTargetedSuppor.TargetedSupportAndImprovementStatusEdFactsCode AS ComprehensiveAndTargetedSuppor_TargetedSupportAndImprovementStatusEdFactsCode
...
JOIN RDS.DimComprehensiveAndTargetedSupports ComprehensiveAndTargetedSuppor
	ON fact.ComprehensiveAndTargetedSupportI = ComprehensiveAndTargetedSuppor.DimComprehensiveAndTargetedSupportId
...
JOIN RDS.DimEarlyChildhoolOrganizationStatuses EarlyChildhoodOrganizationStatus
