-- View: RDS.vwFactDirectoryParquet
-- Generated from database export

CREATE VIEW [RDS].[vwFactDirectoryParquet] AS
CREATE   VIEW RDS.vwFactDirectoryParquet AS SELECT fact.FactDirectoryId
