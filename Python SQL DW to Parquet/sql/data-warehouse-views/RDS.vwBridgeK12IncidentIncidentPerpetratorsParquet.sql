CREATE OR ALTER VIEW [RDS].[vwBridgeK12IncidentIncidentPerpetratorsParquet] AS
	SELECT fact.BridgeK12IncidentIncidentPerpetratorId
	...
	, fact.IncidentPerpetratorTypeCode
	, fact.IncidentPerpetratorTypeDescription
	, fact.IncidentInjuryTypeCode
	, fact.IncidentInjuryTypeDescription
FROM RDS.BridgeK12IncidentIncidentPerpetrators fact
