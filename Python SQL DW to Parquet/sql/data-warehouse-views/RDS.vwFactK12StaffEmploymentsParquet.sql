-- View: RDS.vwFactK12StaffEmploymentsParquet
-- Generated from database export

CREATE VIEW [RDS].[vwFactK12StaffEmploymentsParquet] AS
CREATE   VIEW RDS.vwFactK12StaffEmploymentsParquet AS SELECT fact.FactK12StaffEmploymentId
