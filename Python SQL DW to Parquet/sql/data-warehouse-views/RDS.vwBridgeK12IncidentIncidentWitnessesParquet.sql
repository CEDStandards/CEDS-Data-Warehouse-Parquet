CREATE OR ALTER VIEW [RDS].[vwBridgeK12IncidentIncidentWitnessesParquet] AS
	SELECT fact.BridgeK12IncidentIncidentWitnessId
	...
	, fact.IncidentWitnessTypeCode
	, fact.IncidentWitnessTypeDescription
	, fact.IncidentInjuryTypeCode
	, fact.IncidentInjuryTypeDescription
FROM RDS.BridgeK12IncidentIncidentWitnesses fact
