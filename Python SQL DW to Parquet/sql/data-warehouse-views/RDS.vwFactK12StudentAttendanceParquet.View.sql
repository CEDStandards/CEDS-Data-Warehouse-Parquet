/****** Object:  View [RDS].[vwFactK12StudentAttendanceParquet]    Script Date: 5/10/2022 2:48:07 PM ******/

CREATE OR ALTER VIEW [RDS].[vwFactK12StudentAttendanceParquet] AS 
SELECT fact.FactK12StudentAttendanceId
