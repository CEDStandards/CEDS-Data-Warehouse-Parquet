CREATE OR ALTER VIEW [RDS].[vwBridgeK12SchoolGradeLevelsOfferedParquet] AS
	SELECT fact.BridgeK12SchoolGradeLevelId
...
FROM RDS.BridgeK12SchoolGradeLevelsOffered fact
