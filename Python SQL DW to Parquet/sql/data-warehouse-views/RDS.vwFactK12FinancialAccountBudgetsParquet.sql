-- View: RDS.vwFactK12FinancialAccountBudgetsParquet
-- Generated from database export

CREATE VIEW [RDS].[vwFactK12FinancialAccountBudgetsParquet] AS
CREATE   VIEW RDS.vwFactK12FinancialAccountBudgetsParquet AS SELECT fact.FactK12FinancialAccountBudgetId
