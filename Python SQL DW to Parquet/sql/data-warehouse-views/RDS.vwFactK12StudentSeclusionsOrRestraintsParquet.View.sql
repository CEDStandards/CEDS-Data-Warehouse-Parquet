/****** Object:  View [RDS].[vwFactK12StudentSeclusionsOrRestraintsParquet]    Script Date: 5/10/2022 2:48:07 PM ******/

CREATE OR ALTER VIEW [RDS].[vwFactK12StudentSeclusionsOrRestraintsParquet] AS 
SELECT fact.FactK12StudentSeclusionOrRestraintId
	...
	, SeclusionOrRestraintDate.DateValue AS SeclusionOrRestraintDate_DateValue
	, SeclusionOrRestraintDate.Day AS SeclusionOrRestraintDate_Day
	, SeclusionOrRestraintDate.DayOfWeek AS SeclusionOrRestraintDate_DayOfWeek
	, SeclusionOrRestraintDate.DayOfYear AS SeclusionOrRestraintDate_DayOfYear
	, SeclusionOrRestraintDate.Month AS SeclusionOrRestraintDate_Month
	, SeclusionOrRestraintDate.MonthName AS SeclusionOrRestraintDate_MonthName
	, SeclusionOrRestraintDate.SubmissionYear AS SeclusionOrRestraintDate_SubmissionYear
	, SeclusionOrRestraintDate.Year AS SeclusionOrRestraintDate_Year
	, ParentGuardianContactDate.DateValue AS ParentGuardianContactDate_DateValue
	, ParentGuardianContactDate.Day AS ParentGuardianContactDate_Day
	, ParentGuardianContactDate.DayOfWeek AS ParentGuardianContactDate_DayOfWeek
	, ParentGuardianContactDate.DayOfYear AS ParentGuardianContactDate_DayOfYear
	, ParentGuardianContactDate.Month AS ParentGuardianContactDate_Month
	, ParentGuardianContactDate.MonthName AS ParentGuardianContactDate_MonthName
	, ParentGuardianContactDate.SubmissionYear AS ParentGuardianContactDate_SubmissionYear
	, ParentGuardianContactDate.Year AS ParentGuardianContactDate_Year
	, K12StaffFilingSeclusionOrRestraint.FirstName AS K12StaffFilingSeclusionOrRestraint_FirstName
	, K12StaffFilingSeclusionOrRestraint.MiddleName AS K12StaffFilingSeclusionOrRestraint_MiddleName
	, K12StaffFilingSeclusionOrRestraint.LastOrSurname AS K12StaffFilingSeclusionOrRestraint_LastOrSurname
	, K12StaffFilingSeclusionOrRestraint.PersonalTitleOrPrefix AS K12StaffFilingSeclusionOrRestraint_PersonalTitleOrPrefix
	, K12StaffFilingSeclusionOrRestraint.BirthDate AS K12StaffFilingSeclusionOrRestraint_BirthDate
	, K12StaffFilingSeclusionOrRestraint.PositionTitle AS K12StaffFilingSeclusionOrRestraint_PositionTitle
	, K12StaffFilingSeclusionOrRestraint.ElectronicMailAddressHome AS K12StaffFilingSeclusionOrRestraint_ElectronicMailAddressHome
	, K12StaffFilingSeclusionOrRestraint.ElectronicMailAddressWork AS K12StaffFilingSeclusionOrRestraint_ElectronicMailAddressWork
	, K12StaffFilingSeclusionOrRestraint.ElectronicMailAddressOrganizational AS K12StaffFilingSeclusionOrRestraint_ElectronicMailAddressOrganizational
	, K12StaffFilingSeclusionOrRestraint.TelephoneNumberHome AS K12StaffFilingSeclusionOrRestraint_TelephoneNumberHome
	, K12StaffFilingSeclusionOrRestraint.TelephoneNumberWork AS K12StaffFilingSeclusionOrRestraint_TelephoneNumberWork
	, K12StaffFilingSeclusionOrRestraint.TelephoneNumberMobile AS K12StaffFilingSeclusionOrRestraint_TelephoneNumberMobile
	, K12StaffFilingSeclusionOrRestraint.TelephoneNumberFax AS K12StaffFilingSeclusionOrRestraint_TelephoneNumberFax
	, K12StaffFilingSeclusionOrRestraint.EarlyLearningChidIdentifierState AS K12StaffFilingSeclusionOrRestraint_EarlyLearningChidIdentifierState
	, K12StaffFilingSeclusionOrRestraint.K12StudentIdentifierState AS K12StaffFilingSeclusionOrRestraint_K12StudentIdentifierState
	, K12StaffFilingSeclusionOrRestraint.K12StudentIdentifierDistrict AS K12StaffFilingSeclusionOrRestraint_K12StudentIdentifierDistrict
	, K12StaffFilingSeclusionOrRestraint.K12StudentIdentifierNationalMigrant AS K12StaffFilingSeclusionOrRestraint_K12StudentIdentifierNationalMigrant
	, K12StaffFilingSeclusionOrRestraint.PsStudentIdentifierState AS K12StaffFilingSeclusionOrRestraint_PsStudentIdentifierState
	, K12StaffFilingSeclusionOrRestraint.AeStudentIdentifierState AS K12StaffFilingSeclusionOrRestraint_AeStudentIdentifierState
	, K12StaffFilingSeclusionOrRestraint.WorkforcePersonIdentifierState AS K12StaffFilingSeclusionOrRestraint_WorkforcePersonIdentifierState
	, K12StaffFilingSeclusionOrRestraint.EarlyLearningStaffMemberIdentifierState AS K12StaffFilingSeclusionOrRestraint_EarlyLearningStaffMemberIdentifierState
	, K12StaffFilingSeclusionOrRestraint.K12StaffMemberIdentiferState AS K12StaffFilingSeclusionOrRestraint_K12StaffMemberIdentiferState
	, K12StaffFilingSeclusionOrRestraint.K12StaffMemberIdentiferDistrict AS K12StaffFilingSeclusionOrRestraint_K12StaffMemberIdentiferDistrict
	, K12StaffFilingSeclusionOrRestraint.PsStaffMemberIdentiferState AS K12StaffFilingSeclusionOrRestraint_PsStaffMemberIdentiferState
	, K12StaffFilingSeclusionOrRestraint.PersonIdentifierDriversLicense AS K12StaffFilingSeclusionOrRestraint_PersonIdentifierDriversLicense
	, K12StaffFilingSeclusionOrRestraint.IsActiveEarlyLearningChild AS K12StaffFilingSeclusionOrRestraint_IsActiveEarlyLearningChild
	, K12StaffFilingSeclusionOrRestraint.IsActiveK12Student AS K12StaffFilingSeclusionOrRestraint_IsActiveK12Student
	, K12StaffFilingSeclusionOrRestraint.IsActivePsStudent AS K12StaffFilingSeclusionOrRestraint_IsActivePsStudent
	, K12StaffFilingSeclusionOrRestraint.IsActiveAeStudent AS K12StaffFilingSeclusionOrRestraint_IsActiveAeStudent
	, K12StaffFilingSeclusionOrRestraint.IsActiveWorkforcePerson AS K12StaffFilingSeclusionOrRestraint_IsActiveWorkforcePerson
	, K12StaffFilingSeclusionOrRestraint.IsActiveEarlyLearningStaffMember AS K12StaffFilingSeclusionOrRestraint_IsActiveEarlyLearningStaffMember
	, K12StaffFilingSeclusionOrRestraint.IsActiveK12StaffMember AS K12StaffFilingSeclusionOrRestraint_IsActiveK12StaffMember
	, K12StaffFilingSeclusionOrRestraint.IsActivePsStaffMember AS K12StaffFilingSeclusionOrRestraint_IsActivePsStaffMember
	, K12StaffFilingSeclusionOrRestraint.RecordStartDateTime AS K12StaffFilingSeclusionOrRestraint_RecordStartDateTime
	, K12StaffFilingSeclusionOrRestraint.RecordEndDateTime AS K12StaffFilingSeclusionOrRestraint_RecordEndDateTime
	, K12StaffWhoInitiatedIntervention.FirstName AS K12StaffWhoInitiatedIntervention_FirstName
	, K12StaffWhoInitiatedIntervention.MiddleName AS K12StaffWhoInitiatedIntervention_MiddleName
	, K12StaffWhoInitiatedIntervention.LastOrSurname AS K12StaffWhoInitiatedIntervention_LastOrSurname
	, K12StaffWhoInitiatedIntervention.PersonalTitleOrPrefix AS K12StaffWhoInitiatedIntervention_PersonalTitleOrPrefix
	, K12StaffWhoInitiatedIntervention.BirthDate AS K12StaffWhoInitiatedIntervention_BirthDate
	, K12StaffWhoInitiatedIntervention.PositionTitle AS K12StaffWhoInitiatedIntervention_PositionTitle
	, K12StaffWhoInitiatedIntervention.ElectronicMailAddressHome AS K12StaffWhoInitiatedIntervention_ElectronicMailAddressHome
	, K12StaffWhoInitiatedIntervention.ElectronicMailAddressWork AS K12StaffWhoInitiatedIntervention_ElectronicMailAddressWork
	, K12StaffWhoInitiatedIntervention.ElectronicMailAddressOrganizational AS K12StaffWhoInitiatedIntervention_ElectronicMailAddressOrganizational
	, K12StaffWhoInitiatedIntervention.TelephoneNumberHome AS K12StaffWhoInitiatedIntervention_TelephoneNumberHome
	, K12StaffWhoInitiatedIntervention.TelephoneNumberWork AS K12StaffWhoInitiatedIntervention_TelephoneNumberWork
	, K12StaffWhoInitiatedIntervention.TelephoneNumberMobile AS K12StaffWhoInitiatedIntervention_TelephoneNumberMobile
	, K12StaffWhoInitiatedIntervention.TelephoneNumberFax AS K12StaffWhoInitiatedIntervention_TelephoneNumberFax
	, K12StaffWhoInitiatedIntervention.EarlyLearningChidIdentifierState AS K12StaffWhoInitiatedIntervention_EarlyLearningChidIdentifierState
	, K12StaffWhoInitiatedIntervention.K12StudentIdentifierState AS K12StaffWhoInitiatedIntervention_K12StudentIdentifierState
	, K12StaffWhoInitiatedIntervention.K12StudentIdentifierDistrict AS K12StaffWhoInitiatedIntervention_K12StudentIdentifierDistrict
	, K12StaffWhoInitiatedIntervention.K12StudentIdentifierNationalMigrant AS K12StaffWhoInitiatedIntervention_K12StudentIdentifierNationalMigrant
	, K12StaffWhoInitiatedIntervention.PsStudentIdentifierState AS K12StaffWhoInitiatedIntervention_PsStudentIdentifierState
	, K12StaffWhoInitiatedIntervention.AeStudentIdentifierState AS K12StaffWhoInitiatedIntervention_AeStudentIdentifierState
	, K12StaffWhoInitiatedIntervention.WorkforcePersonIdentifierState AS K12StaffWhoInitiatedIntervention_WorkforcePersonIdentifierState
	, K12StaffWhoInitiatedIntervention.EarlyLearningStaffMemberIdentifierState AS K12StaffWhoInitiatedIntervention_EarlyLearningStaffMemberIdentifierState
	, K12StaffWhoInitiatedIntervention.K12StaffMemberIdentiferState AS K12StaffWhoInitiatedIntervention_K12StaffMemberIdentiferState
	, K12StaffWhoInitiatedIntervention.K12StaffMemberIdentiferDistrict AS K12StaffWhoInitiatedIntervention_K12StaffMemberIdentiferDistrict
	, K12StaffWhoInitiatedIntervention.PsStaffMemberIdentiferState AS K12StaffWhoInitiatedIntervention_PsStaffMemberIdentiferState
	, K12StaffWhoInitiatedIntervention.PersonIdentifierDriversLicense AS K12StaffWhoInitiatedIntervention_PersonIdentifierDriversLicense
	, K12StaffWhoInitiatedIntervention.IsActiveEarlyLearningChild AS K12StaffWhoInitiatedIntervention_IsActiveEarlyLearningChild
	, K12StaffWhoInitiatedIntervention.IsActiveK12Student AS K12StaffWhoInitiatedIntervention_IsActiveK12Student
	, K12StaffWhoInitiatedIntervention.IsActivePsStudent AS K12StaffWhoInitiatedIntervention_IsActivePsStudent
	, K12StaffWhoInitiatedIntervention.IsActiveAeStudent AS K12StaffWhoInitiatedIntervention_IsActiveAeStudent
	, K12StaffWhoInitiatedIntervention.IsActiveWorkforcePerson AS K12StaffWhoInitiatedIntervention_IsActiveWorkforcePerson
	, K12StaffWhoInitiatedIntervention.IsActiveEarlyLearningStaffMember AS K12StaffWhoInitiatedIntervention_IsActiveEarlyLearningStaffMember
	, K12StaffWhoInitiatedIntervention.IsActiveK12StaffMember AS K12StaffWhoInitiatedIntervention_IsActiveK12StaffMember
	, K12StaffWhoInitiatedIntervention.IsActivePsStaffMember AS K12StaffWhoInitiatedIntervention_IsActivePsStaffMember
	, K12StaffWhoInitiatedIntervention.RecordStartDateTime AS K12StaffWhoInitiatedIntervention_RecordStartDateTime
	, K12StaffWhoInitiatedIntervention.RecordEndDateTime AS K12StaffWhoInitiatedIntervention_RecordEndDateTime
	...
	, BuildingSpaceDesignType.BuildingSpaceDesignTypeCode AS BuildingSpaceDesignType_BuildingSpaceDesignTypeCode
	, BuildingSpaceDesignType.BuildingSpaceDesignTypeDescription AS BuildingSpaceDesignType_BuildingSpaceDesignTypeDescription
	, SeclusionOrRestraintStatus.ProblemBahaviorTriggerCode AS SeclusionOrRestraintStatus_ProblemBahaviorTriggerCode
	, SeclusionOrRestraintStatus.ProblemBahaviorTriggerDescription AS SeclusionOrRestraintStatus_ProblemBahaviorTriggerDescription
	, SeclusionOrRestraintStatus.ProblemBahaviorTypeCode AS SeclusionOrRestraintStatus_ProblemBahaviorTypeCode
	, SeclusionOrRestraintStatus.ProblemBahaviorTypeDescription AS SeclusionOrRestraintStatus_ProblemBahaviorTypeDescription
	, SeclusionOrRestraintStatus.SeclusionOrRestraintTypeCode AS SeclusionOrRestraintStatus_SeclusionOrRestraintTypeCode
	, SeclusionOrRestraintStatus.SeclusionOrRestraintTypeDescription AS SeclusionOrRestraintStatus_SeclusionOrRestraintTypeDescription
	, SeclusionOrRestraintStatus.SeclusionOrRestraintStudentResponseTypeCode AS SeclusionOrRestraintStatus_SeclusionOrRestraintStudentResponseTypeCode
	, SeclusionOrRestraintStatus.SeclusionOrRestraintStudentResponseTypeDescription AS SeclusionOrRestraintStatus_SeclusionOrRestraintStudentResponseTypeDescription
	, SeclusionOrRestraintStatus.IncidentInjuryTypeCode AS SeclusionOrRestraintStatus_IncidentInjuryTypeCode
	, SeclusionOrRestraintStatus.IncidentInjuryTypeDescription AS SeclusionOrRestraintStatus_IncidentInjuryTypeDescription
	, SeclusionOrRestraintStatus.InterventionFollowUpTypeCode AS SeclusionOrRestraintStatus_InterventionFollowUpTypeCode
	, SeclusionOrRestraintStatus.InterventionFollowUpTypeDescription AS SeclusionOrRestraintStatus_InterventionFollowUpTypeDescription
	...
	, fact.LengthOfSeclusion
	, fact.LengthOfRestraint
	, fact.LengthOfPreventionInterventions
	, fact.LengthOfProblemBehavior
	, fact.SeclusionOrRestraintCount
FROM RDS.FactK12StudentSeclusionsOrRestraints fact
...
JOIN RDS.DimDates SeclusionOrRestraintDate
	ON Fact.SeclusionOrRestraintDateId = SeclusionOrRestraintDate.DimDateId
JOIN RDS.DimDates ParentGuardianContactDate
	ON Fact.ParentGuardianContactDateId = ParentGuardianContactDate.DimDateId
JOIN RDS.DimPeople K12StaffFilingSeclusionOrRestraint
	ON Fact.K12StaffFilingSeclusionOrRestraintId = K12StaffFilingSeclusionOrRestraint.DimPersonId
JOIN RDS.DimPeople K12StaffWhoInitiatedIntervention
	ON Fact.K12StaffWhoInitiatedInterventionId = K12StaffWhoInitiatedIntervention.DimPersonId
...
JOIN RDS.DimBuildingSpaceDesignTypes BuildingSpaceDesignType
	ON Fact.BuildingSpaceDesignTypeId = BuildingSpaceDesignType.DimBuildingSpaceDesignTypeId
JOIN RDS.DimSeclusionOrRestraintStatuses SeclusionOrRestraintStatus
	ON Fact.SeclusionOrRestraintStatusId = SeclusionOrRestraintStatus.DimSeclusionOrRestraintStatusId
