CREATE OR ALTER VIEW [RDS].[vwBridgeK12IncidentIncidentVictimsParquet] AS
	SELECT fact.BridgeK12IncidentIncidentVictimId
	...
	, fact.IncidentVictimTypeCode
	, fact.IncidentVictimTypeDescription
	, fact.IncidentInjuryTypeCode
	, fact.IncidentInjuryTypeDescription
FROM RDS.BridgeK12IncidentIncidentVictims fact
