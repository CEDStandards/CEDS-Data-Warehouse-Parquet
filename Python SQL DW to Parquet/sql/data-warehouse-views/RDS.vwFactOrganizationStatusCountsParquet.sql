CREATE OR ALTER VIEW [RDS].[vwFactOrganizationStatusCountsParquet] AS
	...
	, SchoolQualityOrStudentSuccessIndicator.SchoolQualityOrStudentSuccessIndicatorTypeCode AS SchoolQualityOrStudentSuccessIndicator_SchoolQualityOrStudentSuccessIndicatorTypeCode
	, SchoolQualityOrStudentSuccessIndicator.SchoolQualityOrStudentSuccessIndicatorTypeDescription AS SchoolQualityOrStudentSuccessIndicator_SchoolQualityOrStudentSuccessIndicatorTypeDescription
	, SchoolQualityOrStudentSuccessIndicator.SchoolQualityOrStudentSuccessIndicatorTypeEdFactsCode AS SchoolQualityOrStudentSuccessIndicator_SchoolQualityOrStudentSuccessIndicatorTypeEdFactsCode
	, SchoolPerformanceIndicatorCategory.SchoolPerformanceIndicatorCategoryCode AS SchoolPerformanceIndicatorCategory_SchoolPerformanceIndicatorCategoryCode
	, SchoolPerformanceIndicatorCategory.SchoolPerformanceIndicatorCategoryDescription AS SchoolPerformanceIndicatorCategory_SchoolPerformanceIndicatorCategoryDescription
	, SchoolPerformanceIndicatorCategory.SchoolPerformanceIndicatorCategoryEdFactsCode AS SchoolPerformanceIndicatorCategory_SchoolPerformanceIndicatorCategoryEdFactsCode
...
JOIN RDS.DimSchoolQualityOrStudentSuccessIndicators SchoolQualityOrStudentSuccessIndicator
	ON fact.SchoolQualityOrStudentSuccessIndicatorId = SchoolQualityOrStudentSuccessIndicator.DimSchoolQualityOrStudentSuccessIndicatorId
JOIN RDS.DimSchoolPerformanceIndicatorCategories SchoolPerformanceIndicatorCategory
	ON fact.SchoolPerformanceIndicatorCategoryId = SchoolPerformanceIndicatorCategory.DimSchoolPerformanceIndicatorCategoryId
