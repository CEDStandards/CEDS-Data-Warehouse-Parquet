-- View: RDS.vwFactK12StaffAssessmentsParquet
-- Generated from database export

CREATE VIEW [RDS].[vwFactK12StaffAssessmentsParquet] AS
CREATE   VIEW RDS.vwFactK12StaffAssessmentsParquet AS SELECT fact.FactK12StaffAssessmentId
	...
	, K12Staff.HighestLevelOfEducationComplete