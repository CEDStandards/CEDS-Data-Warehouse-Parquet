-- View: RDS.vwFactK12AcademicCalendarsParquet
-- Generated from database export

CREATE VIEW [RDS].[vwFactK12AcademicCalendarsParquet] AS
CREATE   VIEW RDS.vwFactK12AcademicCalendarsParquet AS SELECT fact.FactK12AcademicCalendarId
	...
	, Lea.StateAbbreviationDescription AS Lea_